...
2. **Code Generation** → Creates native C++ headers and type definitions in `ios/generated/OpentokReactNative/`
...
```
ios/generated/OpentokReactNative/
...
└── OpentokReactNativeJSI.h          # TurboModule interface
```
...
**OpentokReactNativeJSI.h** - The TurboModule interface with comprehensive event structures:
```cpp
namespace facebook::react {
