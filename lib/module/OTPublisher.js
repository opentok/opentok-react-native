...
import { addEventListener, removeEventListener, dispatchEvent, isConnected } from "./helpers/OTSessionHelper.js";
...
export default class OTPublisher extends React.Component {
  ...
  initComponent = () => {
    ...
    if (Platform.OS === 'android') {
      ...
      setTimeout(() => OT.publish(this.context.sessionId, this.state.publisherId), 100);
    }
  };
  getRtcStatsReport() {
