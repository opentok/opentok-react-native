...
class OTPublisherViewNativePackage : TurboReactPackage() {
  ...
  override fun getModule(s: String, reactApplicationContext: ReactApplicationContext): NativeModule? {
    when (s) {
      OTPublisherViewNativeManager.REACT_CLASS -> OTPublisherViewNativeManager(reactApplicationContext)
    }
    return null
  }

  override fun getReactModuleInfoProvider(): ReactModuleInfoProvider = ReactModuleInfoProvider {
    mapOf(OTPublisherViewNativeManager.REACT_CLASS to ReactModuleInfo(
