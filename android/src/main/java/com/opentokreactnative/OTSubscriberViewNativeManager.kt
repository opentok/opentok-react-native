...
class OTSubscriberViewNativeManager(context: ReactApplicationContext) : SimpleViewManager<OTSubscriberViewNative>(), OTSubscriberViewNativeManagerInterface<OTSubscriberViewNative> {
  ...
  override fun createViewInstance(context: ThemedReactContext): OTSubscriberViewNative = OTSubscriberViewNative(context)
